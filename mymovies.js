var actionMoviesArray = [
  ...
  ["Action Name4", "1994", "Director4", "Actors4", "Summary4", "5.4", "Good4", "trailer4"],
...
function displayMovies(arrayName) {
  ...
  if(movieListDiv.innerHTML == "") {
    ...
    for(var i=0; i<arrayName.length; i++) {
      ...
      li.innerHTML = "<strong>Movie name: </strong>" + arrayName[i][0] + " <strong>Year: </strong>" + arrayName[i][1] + " <strong>Director: </strong> " + arrayName[i][2] + " <strong>Actors/Actresses: </strong> " + arrayName[i][3] + " <strong>Summary: </strong> " + arrayName[i][4] + " <strong>IMDB Rate: </strong> " + arrayName[i][5] + " <strong>My Comment: </strong> " + arrayName[i][6] + " <strong>Trailer: </strong> <a href='" + arrayName[i][7] + "'>Trailer</a>";
      ul.appendChild(li);
    }
